const parse_course_id = (course_id: string) => {}
export default parse_course_id;
// NOTE: DEVON REMOVED THIS BECAUSE COURSE ID IS A 6 DIGIT NUMBER
//      AND NOT A STRING OF CHARACTERS AND NUMBERS. THIS COULD
//      POTENTIALLY BE USED IN THE FUTURE IF WE REFACTORED IT,
