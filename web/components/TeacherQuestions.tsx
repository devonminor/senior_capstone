            ...
            <div className='card'>
                <ul className='list-group list-group-flush'>
                    <li className='list-group-item'>
                        Tufts provides its undergraduates the resources of a
                        major research university and the attention of a liberal
                        arts college. Browse our over 150+ majors and minors
                        below! You can narrow down your options by filtering by
                        School, Category, or Program Type.
                    </li>
                    <li className='list-group-item'>
                        The interdisciplinary offerings at Tufts mean you can
                        pursue your interests in and across our three
                        undergraduate schools, all led by inspiring faculty
                        members eager to work with undergraduate students.
                    </li>
                    <li className='list-group-item'>
                        The Tufts University School of Engineering offers
                        rigorous engineering education in a unique environment
                        that blends the intellectual and technology resources of
                        a world-class research university with the strengths of
                        a top-ranked liberal arts college. Choose from more than
                        35 graduate degree and certificate programs, and
