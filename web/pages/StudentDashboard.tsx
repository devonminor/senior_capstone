...
const StudentDashboard = () => {
    ...
    return (
        ...
        <a href="#"><span className="fa fa-angle-left pr-2"></span>Back to Question Bank</a>
        <p className="text-muted">Multiple Choice Question</p>
        <p className="text-justify h5 pb-2 font-weight-bold">What did Radha Krishnan (Cassius Clay at the time) wear
            while
            flying to Rome for
            the 1960 Games?</p>
